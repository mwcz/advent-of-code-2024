//! A solution to day 21 year 2024.
...
//     use super::*;
//
//     const INPUT: &str = include_str!("../input/d21");
//     const EXAMPLE: &str = include_str!("../examples/d21");
//
//     // #[test]
//     // fn d21p1_example_test() {
//     //     assert_eq!(
