//! A solution to day 20 year 2024.
...
//     use super::*;
//
//     const INPUT: &str = include_str!("../input/d20");
//     const EXAMPLE: &str = include_str!("../examples/d20");
//
//     // #[test]
//     // fn d20p1_example_test() {
//     //     assert_eq!(
