//! A solution to day 22 year 2024.
...
//     use super::*;
//
//     const INPUT: &str = include_str!("../input/d22");
//     const EXAMPLE: &str = include_str!("../examples/d22");
//
//     // #[test]
//     // fn d22p1_example_test() {
//     //     assert_eq!(
